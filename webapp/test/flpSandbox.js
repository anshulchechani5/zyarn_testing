		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Zppyarn_testing",
									"targetURL": "#Zppyarntestingzppyartesting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Zppyarntestingzppyartesting-display": {
								"semanticObject": "Zppyarntestingzppyartesting",
								"action": "display",
								"description": "Zppyarn_testing",
								"title": "Zppyarn_testing",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Zppyarntesting.zppyartesting",
									"url": sap.ui.require.toUrl("Zppyarntesting/zppyartesting")
								}
							}
						}
					}
